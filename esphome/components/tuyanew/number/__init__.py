...
from .. import CONF_TUYA_ID, TuyaNew, TuyaNewDatapointType, tuyanew_ns
...
TuyaNewNumber = tuyanew_ns.class_("TuyaNewNumber", number.Number, cg.Component)

DATAPOINT_TYPES = {
    "int": TuyaNewDatapointType.INTEGER,
    "uint": TuyaNewDatapointType.INTEGER,
    "enum": TuyaNewDatapointType.ENUM,
}
...
CONFIG_SCHEMA = cv.All(
    number.number_schema(TuyaNewNumber)
    .extend(
        {
...
async def to_code(config):
    ...
    cg.add(var.set_tuyanew_parent(parent))
