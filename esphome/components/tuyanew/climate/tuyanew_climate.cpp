#include "tuyanew_climate.h"
#include "esphome/core/log.h"

namespace esphome {
namespace tuyanew {

static const char *const TAG = "tuyanew.climate";

void TuyaNewClimate::setup() {
  ...
  if (this->active_state_id_.has_value()) {
    this->parent_->register_listener(*this->active_state_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->target_temperature_id_.has_value()) {
    this->parent_->register_listener(*this->target_temperature_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->current_temperature_id_.has_value()) {
    this->parent_->register_listener(*this->current_temperature_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->eco_id_.has_value()) {
    this->parent_->register_listener(*this->eco_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->sleep_id_.has_value()) {
    this->parent_->register_listener(*this->sleep_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->swing_vertical_id_.has_value()) {
    this->parent_->register_listener(*this->swing_vertical_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->swing_horizontal_id_.has_value()) {
    this->parent_->register_listener(*this->swing_horizontal_id_, [this](const TuyaNewDatapoint &datapoint) {
  ...
  if (this->fan_speed_id_.has_value()) {
    this->parent_->register_listener(*this->fan_speed_id_, [this](const TuyaNewDatapoint &datapoint) {
...
void TuyaNewClimate::control(const climate::ClimateCall &call) {
  ...
  if (call.get_preset().has_value()) {
    ...
    if (this->eco_id_.has_value()) {
      ...
      if (this->eco_type_ == TuyaNewDatapointType::ENUM) {
...
void TuyaNewClimate::control_swing_mode_(const climate::ClimateCall &call) {
...
void TuyaNewClimate::control_fan_mode_(const climate::ClimateCall &call) {
  if (call.get_fan_mode().has_value()) {
    climate::ClimateFanMode fan_mode = *call.get_fan_mode();

    uint8_t tuyanew_fan_speed;
    switch (fan_mode) {
      case climate::CLIMATE_FAN_LOW:
        tuyanew_fan_speed = *fan_speed_low_value_;
        break;
      case climate::CLIMATE_FAN_MEDIUM:
        tuyanew_fan_speed = *fan_speed_medium_value_;
        break;
      case climate::CLIMATE_FAN_MIDDLE:
        tuyanew_fan_speed = *fan_speed_middle_value_;
        break;
      case climate::CLIMATE_FAN_HIGH:
        tuyanew_fan_speed = *fan_speed_high_value_;
        break;
      case climate::CLIMATE_FAN_AUTO:
        tuyanew_fan_speed = *fan_speed_auto_value_;
        break;
      default:
        tuyanew_fan_speed = 0;
        break;
    ...
    if (this->fan_speed_id_.has_value()) {
      this->parent_->set_enum_datapoint_value(*this->fan_speed_id_, tuyanew_fan_speed);
    }
  }
}

climate::ClimateTraits TuyaNewClimate::traits() {
...
void TuyaNewClimate::dump_config() {
  LOG_CLIMATE("", "TuyaNew Climate", this);
  if (this->switch_id_.has_value()) {
...
void TuyaNewClimate::compute_preset_() {
  if (this->eco_) {
...
void TuyaNewClimate::compute_swingmode_() {
...
void TuyaNewClimate::compute_fanmode_() {
  if (this->fan_speed_id_.has_value()) {
...
void TuyaNewClimate::compute_target_temperature_() {
...
void TuyaNewClimate::compute_state_() {
...
void TuyaNewClimate::switch_to_action_(climate::ClimateAction action) {
