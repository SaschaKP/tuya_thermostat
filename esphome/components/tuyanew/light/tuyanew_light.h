...
enum TuyaNewColorType { RGB, HSV, RGBHSV };

class TuyaNewLight : public Component, public light::LightOutput {
 public:
  void setup() override;
  ...
  void set_color_type(TuyaNewColorType color_type) { this->color_type_ = color_type; }
 ...
 protected:
  ...
  optional<TuyaNewColorType> color_type_{};
