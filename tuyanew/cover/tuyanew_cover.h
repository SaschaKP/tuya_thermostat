...
enum TuyaNewCoverRestoreMode {
  COVER_NO_RESTORE,
  COVER_RESTORE,
  COVER_RESTORE_AND_CALL,
};

class TuyaNewCover : public cover::Cover, public Component {
 public:
  void setup() override;
  ...
  void set_restore_mode(TuyaNewCoverRestoreMode restore_mode) { restore_mode_ = restore_mode; }
 ...
 protected:
  ...
  TuyaNew *parent_;
  TuyaNewCoverRestoreMode restore_mode_{};
