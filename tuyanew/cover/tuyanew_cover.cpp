...
static const char *const TAG = "tuyanew.cover";

void TuyaNewCover::setup() {
  ...
  this->parent_->register_listener(report_id, [this](const TuyaNewDatapoint &datapoint) {
...
void TuyaNewCover::control(const cover::CoverCall &call) {
  if (call.get_stop()) {
...
void TuyaNewCover::set_direction_(bool inverted) {
...
void TuyaNewCover::dump_config() {
  ESP_LOGCONFIG(TAG, "TuyaNew Cover:");
...
cover::CoverTraits TuyaNewCover::get_traits() {
