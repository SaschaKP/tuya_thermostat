...
TuyaNewCover = tuyanew_ns.class_("TuyaNewCover", cover.Cover, cg.Component)

TuyaNewCoverRestoreMode = tuyanew_ns.enum("TuyaNewCoverRestoreMode")
RESTORE_MODES = {
    "NO_RESTORE": TuyaNewCoverRestoreMode.COVER_NO_RESTORE,
    "RESTORE": TuyaNewCoverRestoreMode.COVER_RESTORE,
    "RESTORE_AND_CALL": TuyaNewCoverRestoreMode.COVER_RESTORE_AND_CALL,
}
...
CONFIG_SCHEMA = cv.All(
    cover.cover_schema(TuyaNewCover)
    .extend(
        {
