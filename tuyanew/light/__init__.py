...
TuyaNewColorType = tuyanew_ns.enum("TuyaNewColorType")

COLOR_TYPES = {
    "RGB": TuyaNewColorType.RGB,
    "HSV": TuyaNewColorType.HSV,
    "RGBHSV": TuyaNewColorType.RGBHSV,
}

TuyaNewLight = tuyanew_ns.class_("TuyaNewLight", light.LightOutput, cg.Component)

CONFIG_SCHEMA = cv.All(
    light.BRIGHTNESS_ONLY_LIGHT_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(TuyaNewLight),
            ...
            # The TuyaNew MCU handles transitions and gamma correction on its own.
