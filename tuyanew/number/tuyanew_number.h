...
class TuyaNewNumber : public number::Number, public Component {
 public:
  void setup() override;
  void dump_config() override;
  void set_number_id(uint8_t number_id) { this->number_id_ = number_id; }
  void set_write_multiply(float factor) { multiply_by_ = factor; }
  void set_datapoint_type(TuyaNewDatapointType type) { type_ = type; }
 ...
 protected:
  ...
  optional<TuyaNewDatapointType> type_{};
